...
use NikosProGamer\MythicTraveler\libs\jojoe77777\FormAPI\SimpleForm;
use NikosProGamer\MythicTraveler\Task\QueryTaskCaller;

class MythicTraveler extends PluginBase implements Listener{
    ...
    public function onEnable(){
        ...
        if($this->config->getNested("Command.Enabled")){
            ...
            if($this->cmdName == null || $this->cmdName == ""){
                ...
                $this->getServer()->getCommandMap()->register("MythicTraveler", $cmd, $this->cmdName);
            }
        } else{
    ...
    public function onCommand(CommandSender $sender, Command $command, string $label, array $args) : bool{
        if ($command->getName() == "MythicTraveler"){
            $sender->sendMessage(TF::GRAY."---".TF::GOLD." MythicTraveler ".TF::GRAY."---");
            $sender->sendMessage(TF::YELLOW."Version: ".TF::AQUA.$this->pluginVersion);
            $sender->sendMessage(TF::YELLOW."Description: ".TF::AQUA."Travel around the Mythic Network!");
            if($this->selectorSupport){
